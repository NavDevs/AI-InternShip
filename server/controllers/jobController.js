            ...
            return res.json([
                {
                    ...
                    duration: '4 Months',
                    fees: '₹23,999',
                    description: 'A 4-month project-driven Python internship where VTU students build one complete system from scratch. This includes learning web frameworks like Django/Flask, working with databases, and integrating AI APIs for intelligent features. Excellent for final year students looking to build their capstone project.',
                    applyBy: '2026-05-31',
                ...
                },
                {
                    ...
                    duration: '4 Months',
                    fees: '₹23,999',
                    description: 'A 4-month beginner-friendly data science internship where VTU students build one insight-driven system. You will learn to clean data, perform exploratory data analysis, and build predictive models using Python, Pandas, and Scikit-Learn. Mentorship provided by senior data scientists. Flexible working hours.',
                    applyBy: '2026-03-31',
                    link: 'https://kodnest.com',
                    postedAt: new Date().toISOString(),
                    source: 'live',
